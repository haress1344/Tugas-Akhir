    ...
    public Haris07168_GUI() {
        ...
        Logbut.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (ceklogin == true) {
                    try {
                        Haris07168_ObjectModel.admin.dataAdmin();
                        Haris07168_ObjectModel.admin.login(textUsernameLog.getText(), loginpass.getText());
                        String nama = Haris07168_ObjectModel.admin.adminEntity().getNama();
                    ...
                    try {
                        Haris07168_ObjectModel.member.login(textUsernameLog.getText(), loginpass.getText());
                        String nama = Haris07168_ObjectModel.member.memberEntity().getNama();
        ...
        Regbut.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    Haris07168_ObjectModel.member.insertMember(nama, username, pass);
